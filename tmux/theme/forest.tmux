...
set "status-right" "#{?pane_in_mode,#[fg=yellow]#[bg=$bg_color]#[fg=$bg_color]#[bg=yellow] Copy #[fg=$bg_color]#[bg=yellow],}#[fg=$fg_color,bg=$bg_color]#[fg=white,bg=$fg_color] %a %m-%d %H:%M "
